...
\begin{tabularx}{\textwidth}{p{3.6cm}p{2.2cm}X p{2.0cm}}
\toprule
...
hiện tại gồm 17 unit tests cho schema, leakage, split, detailed EDA, forensics, brand
ablation, preference forecast, model, DSS rules và assignment.
