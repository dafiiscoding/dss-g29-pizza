...
Các trọng số cộng đúng 1,0 và là quy tắc nhóm tự đặt cho tầng DSS. Mô hình
chiếm hơn một nửa điểm vì đây là tín hiệu dự báo chính. Traffic và distance
đứng sau vì EDA cho thấy hai yếu tố này liên quan rõ tới trễ. Peak hour,
complexity và weekend có trọng số nhỏ hơn vì vai trò yếu hơn trong dữ liệu.
Đây không phải hệ số học ra từ mô hình và cũng không phải tối ưu thống kê; nếu
có dữ liệu vận hành thật, nhóm có thể chỉnh lại các trọng số này.

Nguồn các con số cụ thể như sau: \(0,55\) là phần nhóm dành cho xác suất mô
hình; \(0,15\) và \(0,12\) dành cho traffic và cự ly vì hai yếu tố này nổi bật
nhất trong EDA; \(0,08\), \(0,06\), \(0,04\) dành cho peak hour, complexity và
weekend vì là tín hiệu phụ. Mốc 10 km là cự ly lớn nhất trong dữ liệu. Mốc 20
của complexity đến từ công thức \(5\) topping tối đa nhân với size score XL
bằng 4. Thang traffic Low=20, Medium=60, High=100 là thang do nhóm đặt theo
thứ tự rủi ro quan sát được: High có tỷ lệ trễ cao hơn Medium và Low rất rõ.
